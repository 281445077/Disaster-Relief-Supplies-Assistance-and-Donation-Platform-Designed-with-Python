...
class Juanzengshenhe(models.Model):
    juanzengid = models.ForeignKey('juanzeng.Juanzeng',verbose_name='捐赠id' ,default=1, on_delete=models.CASCADE ,db_column='juanzengid', editable=False,related_name="juanzengshenhe_Juanzeng_juanzengid")  
    ...
    wupinleibie = models.ForeignKey('wupinleibie.Wupinleibie' ,default=1,db_column='wupinleibie', on_delete=models.CASCADE ,related_name="juanzengshenhe_Wupinleibie_wupinleibie" ) 
    ...
    class Meta:
        db_table = 'juanzengshenhe'
        verbose_name = '捐赠审核'  #单数形式
